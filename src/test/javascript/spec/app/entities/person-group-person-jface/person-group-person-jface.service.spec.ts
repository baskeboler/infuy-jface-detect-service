...
describe('Service Tests', () => {
    ...
    describe('PersonGroupPersonJface Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(PersonGroupPersonJfaceService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/person-group-people';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return PersonGroupPersonJface', () => {
